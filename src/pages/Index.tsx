...
declare global {
  interface WindowEventMap { "yliv:openOverlay": CustomEvent<void>; }
}
...
const Index: React.FC = () => {
  ...
  const handleCloseOverlay = () => {
    ...
    const trigger = document.getElementById("yliv-complete-setup-pill") as HTMLButtonElement | null;
    trigger?.focus();
  };

  // IMPORTANT: bg-transparent to let the global body background show
  return (
